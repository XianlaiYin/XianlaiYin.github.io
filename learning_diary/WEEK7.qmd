...
![Operating procedures at GEE.](img/WEEK7practical.png){width="100%"}
...
![A comparison of the Landsat-based maps, the percentage urban cover from MODIS, the difference in percentage urban land, as well as the bias for each date for three cities: Chengdu (top row), Guangzhou (middle row), and Kunming (bottom row).](img/1-s2.0-S0034425715302637-gr9.jpg)
